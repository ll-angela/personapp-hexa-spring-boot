...
public class TelefonoInputAdapterCli {
    ...
    public void crearTelefono(TelefonoModelCli telefonoModelCli) {
        try {
            Person person = personInputPort.findOne(telefonoModelCli.getIdDuenio());
            ...
            System.out.println("El teléfono no se ha podido crear.");
        }
    }
    ...
    public void editarTelefono(TelefonoModelCli telefonoModelCli) {
        try {
            ...
            System.out.println("El teléfono no se ha podido editar.");
        }
    }
    ...
    public void eliminarTelefono(String number) {
        try {
            ...
            System.out.println("El teléfono con número " + number + " ha sido eliminado.");
        } catch (Exception e) {
            System.out.println("El teléfono no se ha podido eliminar.");
        }
    }
}
