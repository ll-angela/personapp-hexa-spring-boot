...
public class ProfesionInputAdapterCli {
    ...
    public void crearProfesion(ProfesionModelCli profesionModelCli) {
        try {
            ...
            System.out.println("La profesión no se ha podido crear.");
        }
    }
    ...
    public void editarProfesion(ProfesionModelCli profesionModelCli) {
        try {
            ...
            System.out.println("La profesión no se ha podido editar.");
        }
    }
    ...
    public void eliminarProfesion(Integer id) {
        try {
            ...
            System.out.println("La profesión con la identificación " + id + " ha sido eliminada.");
        } catch (Exception e) {
            System.out.println("La profesión no se ha podido eliminar.");
        }
    }
}
