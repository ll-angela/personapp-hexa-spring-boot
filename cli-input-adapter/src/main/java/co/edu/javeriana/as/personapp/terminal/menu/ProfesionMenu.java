...
public class ProfesionMenu {
    ...
    private void menuOpciones(ProfesionInputAdapterCli profesionInputAdapterCli, Scanner keyboard) {
        ...
        do {
            try {
                ...
                switch (opcion) {
                    ...
                    case OPCION_VER_UNO:
                        ...
                        if (id != -1) {
                            ...
                            System.out.println("Dato incorrecto, inténtelo de nuevo.");
                        }
                        break;
                    case OPCION_CREAR:
                ...
                log.warn("Solo se permiten ingresar números.");
            }
        } while (!isValid);
    }
    ...
    private void mostrarMenuOpciones() {
        ...
        System.out.println(OPCION_VER_UNO + " para ver una profesión");
    ...
    private ProfesionModelCli leerPersona(Scanner keyboard) {
        try {
            ...
            System.out.print("Ingrese la descripción de la persona: ");
            String description = keyboard.nextLine();
            return new ProfesionModelCli(id, name, description);
        } catch (InputMismatchException e) {
            log.warn("Algún dato ingresado fue incorrecto. Inténtelo de nuevo.");
