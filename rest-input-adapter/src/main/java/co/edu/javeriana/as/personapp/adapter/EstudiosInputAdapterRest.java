...
public class EstudiosInputAdapterRest {
    ...
    public EstudiosResponse crearEstudios(EstudiosRequest request) {
        try {
            ...
            Person person = personInputPort.findOne(Integer.valueOf(request.getCcPer()));
            Profession profession = professionInputPort.findOne(Integer.valueOf(request.getIdProf()));
    ...
    public EstudiosResponse editarEstudios(EstudiosRequest request) {
        ...
        try {
            ...
            Person person = personInputPort.findOne(Integer.valueOf(request.getCcPer()));
            Profession profession = professionInputPort.findOne(Integer.valueOf(request.getIdProf()));
            Study phone = studyInputPort.edit(Integer.parseInt(request.getIdProf()),
                    Integer.parseInt(request.getCcPer()),
